...
import { ArrowLeft, Briefcase, Calendar, Mail, Users,Phone } from "lucide-react";
...
const ViewApplicantPage = () => {
  ...
  // to fetch applicants applied to particular jobId
  useEffect(() => {
          ...
          {loading ? (
            ...
            <div className={s.grid}>
              {filtered.map((app, index) => {
                return <div key={app.id} className={s.cardBase} style={{
                  ...
                  <div className={s.cardInner}>
                    ...
                    <div className={s.buttonWrapper}>
                      {app.resumeFile ? (
                        <button onClick={() => { handleViewResume(app.resumeFile, app.userId) }}
