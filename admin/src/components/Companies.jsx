...
import { CheckCircle, Link2, Loader, Trash2, Upload, X, XCircle } from 'lucide-react';
...
//   to fetch the companies from the server side
useEffect(()=>{
    ...
    <div className={s.pageContainer}>
        {toast && (
            <div className={s.toastWrapper}>
                <div className={`${s.toastBase} ${
                    toast.type === "success" ?
                    s.toastSuccess : toast.type === "error" ?
                    s.toastError : s.toastConfirm
                }`}>
                  {toast.type === "success" ? (
        ...
        <div className={s.contentWrapper}>
            <header className={s.header}>
                ...
                <p className={s.headerSubtitle}>Upload logo and provide website URL.</p>
            </header>
                ...
                <form onSubmit={handleSubmit} className={s.form}>
                    ...
                    <div>
                        ...
                        <div className={s.logoContainer}>
                            ...
                            <div className={s.uploadArea}>
                                ...
                                <input type="file" id='logo-upload' ref={fileInputRef} accept='image/*,jpeg,image/svg+xml,..ico' onChange={handleLogoChange} className={s.fileInputHidden} />
                            </div>
                        </div>
                    ...
                    <div className=''>
                        ...
                        <div className={s.inputWrapper}>
                            ...
                            <input type="url" value={website} onChange={(e) =>setWebsite(e.target.value)} className={`${s.websiteInput} ${
                    ...
                    <div className={s.submitSection}>
                        ...
                        isLoading? s.submitBtnDisabled :""  
                            ...
                            {isLoading ? (
                                <>
                                    <Loader size={20} className={s.spinner} />
                                </>
                            ): (
                                "Add Company"
                            )}
                        ...
                        {companies.map((c)=>(
                            <div key={c._id} className={s.companyCard}>
                                ...
                                <div className={s.cardDetails}>
                                        <a href={c.website} target='_blank' rel='noreferrer' className={s.cardLink}>
                                            {c.website}
                                        </a>
                                </div>
                                {/* delete icon */}
                                <div className={s.cardDeleteWrapper}>
                                    <button onClick={()=> requestDeleteCompany(c._id)} className={s.deleteBtn} >
                                        <Trash2 size={18} />
                                    </button>
                                </div>
                            </div>
