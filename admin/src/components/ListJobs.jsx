...
// small reusable component Badge
...
// if salary not found it will not be disclosed
// else it will show the amount with the period(time)
...
export default function ListJobs() {
  ...
  // fetch these details from backend
  ...
  // fetch jobs coming from the server side
  ...
  // edit but it will change when we hit the save btn
  const openEdit = (job) => {
  ...
  // to update the edited data and update
  const handleSave = async (e) => {
    ...
    try {
      ...
      ); //append the field either update one or the last save
