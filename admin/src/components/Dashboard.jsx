...
import { Briefcase, Building, CheckCircle, Filter, MapPin, Search, TrendingUp, User, Users, X, XCircle } from 'lucide-react';
...
const Dashboard = () => {
    ...
    // fallback for logos that failed to load
                ...
                toast && (
                    <div className={s.toastWrapper}>
                        <div className={`${s.toastBase} ${
                          toast.type === "success" ? s.toastSuccess : toast.type === "error" ?
            ...
            <div className={s.contentWrapper}>
                        ...
                        return (
                            <div key={stat.label} className={s.statCard}>
                                ...
                                <div className={s.statCardContent}>
                                    ...
                                    <div className={`${s.statCardIconWrapper} ${
                                    stat.colors.bgLight
                                    } bg-linear-to-br ${stat.colors.gradient}`}
                                    >
                ...
                <div className={s.jobsSection}>
                    ...
                    <h2 className={s.jobsTitle}>
                        ...
                        {statusFilter === "active" ? "Active Roles" : "statusFilter" === "closed" ?
                        "closed Roles": "All Roles"}
                    </h2>
                              ...
                              <div className={s.jobCardContent}>
                                <div className={s.jobCardHeader}>
                                    <div className={s.jobLogoContainer}>
                                        <div className={s.jobLogoWrapper}>  
                                            <img src={job.logo} alt={job.name} className={s.jobLogo} onError={handleImageError} />
                                ...
                                <div className={s.jobMeta}>
                                    ...
                                    <div className={s.jobApplicants}>
                                      <User className={s.jobApplicantsIcon} />
                                ...
                                <div className={s.jobActions}>
                                  ...
                                  })} className={s.viewApplicantsBtn}>View Applicants</button>
                                  {job.status === "active" && (
                                    <button onClick={()=>handleCloseJob(job.id)} className={s.closeJobBtn}>
                                        Close Job
                                    </button>
                                  )}
                                </div>
