...
//this func will return csv file data into plain text 
...
const splitMulti = (cell) =>
  (cell || "")
    ...
    .split(/[\n;\|]+/)
    .map((s) => s.trim())
    .filter(Boolean); //split csv file data by /
...
function uniquePairs(arr) {
  ...
  return out;
} //will create a pair of rolename and data
...
const ListRoleQuestion = () => {
  ...
  // to fetch roles coming from server side
