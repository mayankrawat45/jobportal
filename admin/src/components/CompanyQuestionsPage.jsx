...
// Simple CSV parcel that handles quoted fields and commas inside quote
...
const CompanyQuestionsPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) {
            try {
                ...
                setToast({
                        type: "error",
                        message: error.response?.data?.message ||  "Failed to add Interview Questions",
                    });
            } finally{
    ...
    const parsedCountForDisplay  = parseCountString(questionsCount) || parsedQuestions.length;
        ...
        <div className={s.pageContainer}>
            ...
            <div className={s.contentWrapper}>
                <header className={s.header}>
                    ...
                    <p className={s.headerSubtitle}>Add company detail and upload a question bank CSV (Question,
                    Answer ,Keypoints, PostDate optional).</p>
                </header>
                {/* form card */}
