...
import { ArrowLeft, CheckCircle, Eye, EyeOff, Lock, LogIn, Mail, X } from 'lucide-react';
...
const LoginPage = () => {
    ...
    const handleResetPassword = async (e) => {
        e.preventDefault();
        if (!otp || !newPassword) {
            setToast({ message: "OTP and NewPassword is required", type: "error" })
        }
        try {
            setIsLoading(true);
                            ...
                            {view === "login" && (
                                <>
                                    ...
                                    <p className={s.headerSubtitle}>
                                        Acess your Applications, saved jobs and profile.
                                    </p>
                                    ...
                                    <form onSubmit={handleSubmit} className={s.form}>
                                        ...
                                        <div>
                                            <label htmlFor="" className={s.label}>Password</label>
                                            <div className={s.inputWrapper}>
                                                ...
                                                <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)}
                                                    ...
                                                    placeholder='.......'
                                                />
                                                <button type='button' onClick={() => setShowPassword(!showPassword)} className={s.passwordToggle}>
                                                    {showPassword ? (
                                                        <EyeOff size={18} />
                                                    ) : (
                                                        <Eye size={18} />
