...
import { ArrowRight, Backpack, Briefcase, ChevronRight, CircleChevronRight, Play, PlayCircle, X } from "lucide-react"
// lottie logo
    ...
    <div className={s.bannerContainer}>
          ...
          <div className={s.grid}>
            <div className={s.leftColumn}>
              ...
              <p className={s.description}>
                ...
                professionals who found thier perfect career match through our advanced AI-powered job portal.
              </p>
            ...
            <div className={s.rightColumn}>
              <div className={`${s.cardContainer} ${isXL ? "hover: rotate-y-12 rotate-0" : "rotate-0"
                }`}>
                <div className={s.card}>
                  <div className={s.cardHeader}>
                    <div className='flex item-center gap-3'>
                      ...
                      <div>
                        ...
                        <p className={s.featuredSubtitle}>Update Daily</p>
                      </div>
                    </div>
                  </div>
                            ...
                            <div className={s.jobLogoContainer}>
                              {typeof job.logo === "string" &&
                                ...
                                <div className='w-full h-full p-1 flex items-center justify-center'>
                                  <LottieLogo src={job.logo} size={lottieSize} />
                                </div>
                              ) : (
                  ...
                  <div className={s.viewAllContainer}>
                    <button onClick={() => navigate('/jobs')} className={s.viewAllButton}>
      ...
      {showVideo && (
        <div className='fixed inset-0 z-50 flex items-center justify-center px-4' role='dialog'>
          <div className={s.modalBackdrop} onClick={() => setShowVideo(false)}>
            <div className={s.modalPanel}>
              <button className={s.modalCloseButton} ref={closeBtnRef} onClick={() => setShowVideo(false)}>
                <X className={s.modalCloseIcon} />
              </button>
              <div className={s.modalVideoWrapper}>
                <div className={s.modalVideoContainerClass} style={{
                  paddingTop: "56.25%"
                }}>
                  <video ref={videoRef} src={DEMO_VIDEO_URL} controls autoplay muted playsInline style={s.modalVideoContainer} />
                </div>
              </div>
            </div>
          </div>
