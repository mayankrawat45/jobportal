...
import { Award, Clock, Globe as World, GraduationCap, Lightbulb, Star, Zap, Briefcase, Users as Team, Globe, Users, CheckCircle, Target, Mail, ArrowRight } from 'lucide-react';
...
const Candidate = () => {
  ...
  );//for large screen or small
  const isXL = windowWidth >= 1280;

  // this will maintain the ui responsivness
  useEffect(() => {
    let t = null;
    const onResize = () => {
      clearTimeout(t);
  ...
  // these functions are for mouse movement(ie when mouse enter,exists or moves(job))
        ...
        <header className={s.header}>
          <div className={s.headerGlowWrapper}>
            <div className={s.headerGlow}>
              <div className={s.headerGlowEffect}></div>
