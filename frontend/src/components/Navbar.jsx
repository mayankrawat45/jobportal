...
import { Bookmark, Briefcase, ChevronDown, ChevronUp, Home, LogIn, LogOut, Menu, Search, User, UserCog, UserPen, X } from "lucide-react"
...
}, [location]); //to check and always active the home tab as active 
...
}, [location]);   //to get key form localStorage
...
}, []); //to sync user after localstorage gets updated
...
}, [isUserMenuOpen]); //to check user menu open or not 
                        ...
                        <div className={s.mobileMenuSpace}>
                            {navItems.map((item) => (
                                <button key={item.id} onClick={() => handleNavClick(item)}
                                    ...
                                    <div className={s.mobileNavIconWrapper(activeNavItem === item.id)}>
                                        {item.icon}
                                    </div>
                                    ...
                                    {!user ?(
                                        ...
                                        <>
                                            ...
                                            <div className={s.mobileProfileGrid}>
                                                <Link to='/viewprofile' className={s.mobileProfileButton} onClick={()=>setIsMobileMenuOpen(false)}>
