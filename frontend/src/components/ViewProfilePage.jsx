...
const Toast = ({message, type = "success", onClose}) =>{
    ...
    return (
        <div className={s.toast.container}>
          <div className={`${s.toast.card} ${type === "success"? s.toast.cardSuccess : s.toast.cardError}`}>
            <div className={`${s.toast.indicator} ${type === "success" ? s.toast.indicatorSuccess: s.toast.indicatorError}`} />
...
const ViewProfilePage = () => {
    ...
    const handlePhoneChange =(e) =>{
        ...
        const digtis = raw.replace(/\D/g,"").slice(0,10);
        setProfile((prev)=> ({...prev,phone: digtis}))
    }
...
// to update user profile
  ...
  //to open the uploaded resume on the chrome
        ...
        <div className={s.formGrid}>
            ...
            <div className={s.fieldGroup}>
                ...
                {isEditing ? (
                    ...
                    onChange={handleChange} className={s.input} placeholder='Jhon Doe'
                    required
                     />
                ):(
